...
public class HibernateEHCacheMain {
	...
	public static void main(String[] args) {
		...
		emp = (Employee) session.load(Employee.class, new Long(1));
		...
		emp = (Employee) session.load(Employee.class, new Long(3));
		printData(emp, stats, 4);
		
		emp = (Employee) otherSession.load(Employee.class, new Long(3));
